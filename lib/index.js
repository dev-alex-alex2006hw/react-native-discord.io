...
function handleWSOpen(opts) {
	var ident = {
		...
		"d": {
			...
			"properties": {
				"$os": isNode ? require('os-browserify').platform() : navigator.platform,
				"$browser":"discord.io",
				"$device":"discord.io",
				"$referrer":"",
				"$referring_domain":""
